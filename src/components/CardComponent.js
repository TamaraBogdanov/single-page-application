			...
			<div className="cards-container">
				<div className="cards-wrapper">
					<ul className="cards-items">
						<Card
							src="./single-page-application/images/img-5.jpg"
					...
					<ul className="cards-items">
						<Card
							src="./single-page-application/images/img-3.jpg"
							text="Explore essays i've written about NetArt!"
							label="Essays"
							path="/theory"
						/>
						<Card
							src="./single-page-application/images/img-8.jpg"
							text="NetArt Preperations and Reflections!"
							label="Theory"
							path="/art"
						/>
						<Card
							src="./single-page-application/images/img-2.jpg"
